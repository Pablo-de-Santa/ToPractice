...
const theNameOfTheMovie = prompt("What was the last movie you've watched?");

const theRatingOfTheMovie = +prompt("How would you rate it?");

personalMovieDB.movies[theNameOfTheMovie] = theRatingOfTheMovie;
